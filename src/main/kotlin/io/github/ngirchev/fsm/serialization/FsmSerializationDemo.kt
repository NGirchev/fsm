...
object FsmSerializationDemo {
    ...
    fun main(args: Array<String>) {
        println("=" * 70)
        println("FSM serialization demonstration")
        println("=" * 70)
        println()
    ...
    private fun simpleOrderFsm() {
        ...
        transitionTable.toJson(Path("simple_order_fsm1.json"))
    }
    ...
    private fun complexOrderFsm() {
        ...
        println("--- PlantUML ---")
        transitionTable.toJson(Path("simple_order_fsm2.json"))
    }
